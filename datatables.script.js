$(document).ready(function () {
    $("#zero_configuration_table").DataTable(), $("#feature_disable_table").DataTable({
        paging: !1, ordering: !1, info: !1
    }
    ), $("#deafult_ordering_table").DataTable({
        order: [[3, "desc"]]
    }
    ), $("#deafult_ordering_table_2").DataTable({
        order: [[1, "asc"]],
        pageLength: 50
    }
        ...
        pageLength: 50, scrollY: "200px", scrollCollapse: !0, paging: !1
    }
    ), $("#scroll_horizontal_table").DataTable({
        pageLength: 50, scrollX: !0
    }
    ), $("#scroll_vertical_dynamic_height_table").DataTable({
        pageLength: 50, scrollY: "50vh", scrollCollapse: !0, paging: !1
    }
    ), $("#scroll_horizontal_vertical_table").DataTable({
        pageLength: 50, scrollY: 200, scrollX: !0
    }
        ...
        language: {
            lengthMenu: "Display _MENU_ records per page", zeroRecords: "Nothing found - sorry", info: "Showing page _PAGE_ of _PAGES_", infoEmpty: "No records available", infoFiltered: "(filtered from _MAX_ total records)"
        }
    }
    )
}
